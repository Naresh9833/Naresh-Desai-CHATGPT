...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6187282698:AAH0976uXotiUHZah1IepSRLyWJrvylr5Lg"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Naresh Desai ChatGPT'
username = 'Naresh_Desai1998_bot'
